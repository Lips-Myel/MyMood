...
class Roles
{
    ...
    private Collection $roleOwner;

    public function __construct()
    {
        $this->roleOwner = new ArrayCollection();
    }
    ...
    {
        if (!$this->roleOwner->contains($roleOwner)) {
            $this->roleOwner->add($roleOwner);
    ...
    {
        if ($this->roleOwner->removeElement($roleOwner)) {
